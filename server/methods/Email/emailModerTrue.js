Meteor.methods({
	emailModerTrue(item) {
		...
		var user = Meteor.users.findOne(item.user);
	...
	'					Ваши изменения в техническиое задание по работе над сайтом были утверждены. Пожалуйста, ознакомьтесь ещё раз с текстом задания, т.к. возможно туда были добавлены ещё правки с нашей стороны. Стоимость работы так же была переоценена. Если вас устраивают новые условия, пожалуйста, оформляйте ваш заказ!'+
	'					</td>'+
	...
	'	</html>';
		...
		Email.send({
			...
			subject: 'Заказ прошел проверку и ожидает оформления',
			html: html
		});
