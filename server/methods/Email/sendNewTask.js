Meteor.methods({
	...
	'					Только что пришел заказ на выполнение новой задачи. Пожалуйста, ознакомьтесь с техническим заданием и приступайте к работе!'+
	'					</td>'+
	...
	'	</html>';
		...
		var developer = Meteor.users.findOne(userId);
		...
		Email.send({
			...
			subject: 'У вас новая задача ['+ taskId +']',
			html: html
		});
	}
});
