Meteor.methods({
	sendProjectDesinger(projectId, userId) {
	...
	'					Вы были назначены дизайнером на новый проект. Пожалуйста приступайте к задачам проекта по дизайну в порядке очередности списка'+
	'					</td>'+
	...
	'	</html>';
		...
		Email.send({
			...
			subject: 'У вас новый проект (Дизайн)) ['+ projectId +']',
			html: html
		});
