Meteor.methods({
	...
	'				Новый компонент ожидает модерации'+
	'				</td>'+
	...
	'					Только что пришел новый заказ, в котором клиент решил изменить техническиое задание одного компонента. Компонента ожидает модерации и оценки.'+
	'					</td>'+
	...
	'	</html>';
		...
		Email.send({
			...
			subject: 'Заказ ожидает модерации',
			html: html
		});
