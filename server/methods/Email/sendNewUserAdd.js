Meteor.methods({
	...
	'					Только что появился новый клиент, который ожидает обработки в разделе "Пользователи".'+
	'					</td>'+
