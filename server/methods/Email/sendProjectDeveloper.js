Meteor.methods({
	sendProjectDeveloper(projectId, userId) {
	...
	'					Вы были назначены программистом на новый проект. Пожалуйста приступайте к задачам проекта по коду в порядке очередности списка'+
	'					</td>'+
	...
	'	</html>';
		...
		Email.send({
			...
			subject: 'У вас новый проект (Код)) ['+ projectId +']',
			html: html
		});
